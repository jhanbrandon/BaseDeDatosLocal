...
CREATE TABLE `ventasdetalle` (
  ...
  CONSTRAINT `ventasdetalle_ibfk_1` FOREIGN KEY (`VentaID`) REFERENCES `ventas` (`VentaID`),
  CONSTRAINT `ventasdetalle_ibfk_2` FOREIGN KEY (`ProductoID`) REFERENCES `productos` (`ProductoID`)
...
INSERT INTO `ventasdetalle` VALUES (1,1,1,2,12.50,25.00),(2,1,2,5,8.90,44.50),(3,1,3,10,0.10,1.00),(4,2,4,1,20.00,20.00),(5,2,5,3,3.50,10.50),(6,2,6,50,0.05,2.50);
