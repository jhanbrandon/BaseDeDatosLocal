...
CREATE TABLE `ventas` (
  ...
  `EstadoDeVenta` tinyint(1) NOT NULL,
  PRIMARY KEY (`VentaID`),
  KEY `ClienteID` (`ClienteID`),
  KEY `UsuarioID` (`UsuarioID`),
  CONSTRAINT `ventas_ibfk_1` FOREIGN KEY (`ClienteID`) REFERENCES `clientes` (`ClienteID`),
  CONSTRAINT `ventas_ibfk_2` FOREIGN KEY (`UsuarioID`) REFERENCES `usuario` (`UsuarioID`)
...
INSERT INTO `ventas` VALUES (1,'V-2024-001','2024-09-08','10:30:00',1,2,'Tarjeta',1),(2,'V-2024-002','2024-09-08','14:45:00',2,3,'Efectivo',1);
